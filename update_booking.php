...
if(!($stmt = $mysqli->prepare("UPDATE bookings b INNER JOIN properties p ON b.prop_id = b.prop_id
                                SET b.beg_date = ?, b.end_date = ?, total_cost = (
                                    SELECT DATEDIFF(?, ?) * (
                                    SELECT daily_cost
                                    FROM properties p
...
if(!($stmt->bind_param("sssss", $_POST['beg_date'], $_POST['end_date'], $_POST['end_date'], $_POST['beg_date'], $_POST['booking_id']))){
